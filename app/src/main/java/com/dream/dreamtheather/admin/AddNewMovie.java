...
public class AddNewMovie extends Fragment implements RequestListener<Drawable>, OnFailureListener, OnCompleteListener<QuerySnapshot> {
...
//                    && WebViewFragment.getIDYoutube(getContext(),s.toString())!=null
            )
            mDone[3] = true;
            else {
                mDone[3] = false;
